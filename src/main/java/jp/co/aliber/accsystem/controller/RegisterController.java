...
public class RegisterController {
	...
	public String save(Model model, @Validated LoginUserInfoForm form, BindingResult result) {
		// 入力チェック
	 ...
	 *         入力チェック結果
	 */
	private boolean validate(Model model, LoginUserInfoForm form, BindingResult result) {
