...
public class CompanyBasicInfoForm implements Serializable {
     ...
     * @return userRecongId
     */
    public Integer getUserRecongId() {
        return userRecongId;
    }
     ...
     *            セットする userRecongId
     */
    public void setUserRecongId(Integer userRecongId) {
