...
public class TEmployeeFixedPaymentService {
     ...
     */
    public TEmployeeFixedPayment getTEmployeeFixedPayment(Integer emplyeeId, Integer compId) {
        return tEmployeeFixedPaymentMapper.selectByPrimaryKey(emplyeeId, compId);
    }
}
