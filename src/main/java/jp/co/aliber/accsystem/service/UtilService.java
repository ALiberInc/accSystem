...
public class UtilService {
	 ...
	 * @throws JRException
	 */
	public ByteArrayOutputStream creationPdfOutputStream(Integer employeeId, Integer compId, String salaryYearMonth)
		...
		// 所得税
		salaryBean.setIncomeTax(tSalaryDetail.getIncomeTax() != null ? tSalaryDetail.getIncomeTax().toString() : "0");
		// 住名税
		salaryBean.setLivingTax(tSalaryDetail.getLivingTax() != null ? tSalaryDetail.getLivingTax().toString() : "0");
		// 積立金
