...
public class EmployeeFixedDeductionService {
	 ...
	 */
	public TEmployeeFixedDeduction getTEmployeeFixedDeduction(Integer employeeId, Integer compId) {
		return tEmployeeFixedDeductionMapper.selectByPrimaryKey(employeeId, compId);
	}
}
